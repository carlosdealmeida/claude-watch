...
<!--
Tip: add a real screenshot and reference it here, e.g.:
...
Built with **.NET 10 + WPF**. See **[docs/DEVELOPMENT.md](docs/DEVELOPMENT.md)** to build, test, publish, and cut releases.
