...
<!--
Consejo: agrega una captura real y referénciala aquí, por ejemplo:
...
Hecho con **.NET 10 + WPF**. Consulta **[docs/DEVELOPMENT.md](docs/DEVELOPMENT.md)** para compilar, probar, publicar y crear releases.
